  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-4xl">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <button
          onClick={onReset}
          className="px-4 py-2 border border-gray-600 hover:border-blue-500 hover:text-blue-400 rounded-lg text-sm font-medium text-gray-400 transition-colors flex items-center gap-2"
        >
